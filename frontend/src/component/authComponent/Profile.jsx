                                ...
                                <form>
                                    ...
                                    <div className="flex lg:flex-row md:flex-col sm:flex-col xs:flex-col gap-2 justify-center w-full">
                                        <div className="w-full">
                                            <h3 className="dark:text-gray-300 mb-2">Giới tính</h3>
                                        ...
                                        <div className="w-full">
                                            <h3 className="dark:text-gray-300 mb-2">Ngày sinh</h3>
                                            <input
                                                type="text"
                                                name="dob"
                                                value={formData.dob}
                                    ...
                                    <div className="w-full rounded-lg bg-blue-500 mt-4 text-white text-lg font-semibold">
                                        <button onClick={handleSubmit} type="submit" className="w-full p-4">Lưu thay đổi</button>
                                    </div>
                                </form>
                            </div>
                        </div>
